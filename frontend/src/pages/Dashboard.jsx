                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex items-center gap-5 mt-3 sm:mt-0">
                                <div className="text-right">
                                  <p className="font-bold text-slate-900 dark:text-white text-sm">${parseFloat(item.prix || 0).toLocaleString()}</p>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-[#0B101D] border border-slate-200 dark:border-slate-800/80 rounded-2xl p-5 shadow-xl space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <code className="text-[11px] font-mono text-slate-800 dark:text-slate-300 break-all bg-slate-100 dark:bg-[#070A12] p-2.5 rounded-xl block border border-slate-200 dark:border-slate-800">
                    {user.wallet_address
                ...
                <div className="flex items-center justify-between pt-3 border-t border-slate-200 dark:border-slate-800 text-[10px] text-slate-500 dark:text-slate-400">
                  ...
                  <ExternalLink size={13} className="text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer" />
                </div>
              </div>
            </div>
          </div>
