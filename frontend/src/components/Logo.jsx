...
export const LogoIcon = ({ size = "md" }) => {
  ...
  return (
    <div className={`${sizeClasses} bg-slate-900/80 border border-slate-700 flex items-center justify-center text-white shadow-lg overflow-hidden group-hover:scale-105 transition-transform p-1`}>
      <img src={logoImg} alt="Kivu Immobilier Logo" className="w-full h-full object-contain" />
    </div>
  );
};
